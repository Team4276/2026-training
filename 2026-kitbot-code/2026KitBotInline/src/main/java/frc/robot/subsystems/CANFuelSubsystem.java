...
public class CANFuelSubsystem extends SubsystemBase {
  private final CustomMotor feederRoller;
  private final CustomMotor intakeLauncherRoller;

  /** Creates a new CANBallSubsystem. */
  public CANFuelSubsystem() {
    // create brushed motors for each of the motors on the launcher mechanism
    intakeLauncherRoller = new CustomMotor(Constants.FuelConstants.INTAKE_LAUNCHER_MOTOR_ID);
    feederRoller = new CustomMotor(Constants.FuelConstants.FEEDER_MOTOR_ID);
